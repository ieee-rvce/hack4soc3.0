...
const Tracks = lazy(() => import("@/components/landing/Tracks").then(m => ({ default: m.Tracks })));
const Timeline = lazy(() => import("@/components/landing/Timeline").then(m => ({ default: m.Timeline })));
const Prizes = lazy(() => import("@/components/landing/Prizes").then(m => ({ default: m.Prizes })));
const Venue = lazy(() => import("@/components/landing/Venue").then(m => ({ default: m.Venue })));
const Sponsors = lazy(() => import("@/components/landing/Sponsors").then(m => ({ default: m.Sponsors })));
const Faq = lazy(() => import("@/components/landing/Faq").then(m => ({ default: m.Faq })));
const FinalCta = lazy(() => import("@/components/landing/FinalCta").then(m => ({ default: m.FinalCta })));
const Footer = lazy(() => import("@/components/landing/Footer").then(m => ({ default: m.Footer })));
const LiquidEther = lazy(() => import("@/components/landing/effects/LiquidEther"));
  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-0 z-0 bg-[#E8F8F0]">
        ...
        >
          <Suspense fallback={<div className="absolute inset-0 bg-[#E8F8F0]" />}>
            <LiquidEther
      ...
      <main id="top" className="relative z-10 min-h-screen text-foreground font-sans">
        <GrainOverlay />
        <Nav />
        <Hero />

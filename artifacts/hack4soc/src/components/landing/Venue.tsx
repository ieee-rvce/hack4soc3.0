...
export function Venue() {
  return (
    <section id="venue" className="relative overflow-hidden bg-brand-deep/75 py-32 backdrop-blur-[2px]">
      {/* Background illustration */}
      <div className="absolute inset-0 z-0 opacity-20">
        <img src="/images/skyline.png" alt="Bengaluru Skyline Background" loading="lazy" className="h-full w-full object-cover object-bottom" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-12">
        <div className="flex flex-col gap-12 md:flex-row md:items-end md:justify-between mb-16">
          ...
          <ArrowButton href="https://maps.app.goo.gl/bzZKm6dCvmCg12B76" className="self-start md:self-auto" variant="primary">
            GET DIRECTIONS
          </ArrowButton>
        </div>
